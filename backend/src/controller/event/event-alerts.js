...
// get task alerts of a specific event
...
// get tall task alerts for a specific user
eventAlert.get('/get', checkAuth, (req, res) => {
  ...
  Event.find({ 'host.user_id': req.userData.user_id }).then(results => {
    // loop through events

...
const merchantSchema = mongoose.Schema(
  {
    ...
    business: { type: {
      ...
      business_contact_no: {type: String, required: true},
      business_address_line1: {type: String, required: true},
      business_address_line2: {type: String},
      business_postal_code: {type: String, required: true},
      business_created_date: {type: String, required: true},
      business_location: {type:{lat: Number, lang: Number, homeTown: String}, required: true},

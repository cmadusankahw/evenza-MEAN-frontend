...
import { PaymentData, MerchantPayments, findMonth, printCanvas } from 'src/app/modules/admin/admin.model';
...
export class SpPaymentsReportComponent implements OnInit, OnDestroy {
  ...
  // chat URLs
  url1 = "https://charts.mongodb.com/charts-project-0-ywcjk/embed/charts?id=8f1dde2f-6427-429e-864b-42384d914906&autoRefresh=300&theme=light";
  url2 = "https://charts.mongodb.com/charts-project-0-ywcjk/embed/charts?id=eb88acb5-759a-4b68-8a0f-422a2be098dc&autoRefresh=300&theme=light";
  url3 = "https://charts.mongodb.com/charts-project-0-ywcjk/embed/charts?id=49e05742-09d3-4cf0-8df7-965ada65927b&autoRefresh=300&theme=light";
